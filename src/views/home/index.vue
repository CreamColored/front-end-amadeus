      ...
      <div class="home-section recommend-courses">
        <div class="container">
          <div class="home-section-header">
            ...
            <div class="home-section-tabs">
              <ul class="nav nav-tabs">
                ...
                <li><a href="#recent-course" style="margin: 0 60px" data-toggle="tab">最新课程</a></li>
                <li class="active"><a href="#hot-course" data-toggle="tab">热门课程</a></li>
              </ul>
            </div>
          </div>
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="boutique-course">
              <div class="row">
                <div class="col-md-3" v-for="boutiqueCourse in boutiqueCourseList">
                  <a class="recommend-courses-item" :href="'#/course/'+boutiqueCourse.courseId">
                    <img :src="boutiqueCourse.courseImage.smallImage" :alt="boutiqueCourse.courseName">
                    <div class="recommend-courses-content">
                      <div class="recommend-courses-name">{{boutiqueCourse.courseName}}</div>
                      <div class="recommend-courses-desc">{{boutiqueCourse.description}}</div>
                      <div class="recommend-courses-users">
                        <i class="fa fa-users"></i>{{boutiqueCourse.clickNumber}}
                        <span style="float: right;font-size: 16px;color: #F00;" v-if="boutiqueCourse.coursePrice.isFree">免费</span>
                        <span style="float: right;font-size: 16px;color: #F00;" v-else-if="boutiqueCourse.coursePrice.discountPrice!==boutiqueCourse.coursePrice.originalPrice"><del style="font-size: 14px;color: #ccc;">￥{{boutiqueCourse.coursePrice.originalPrice}}</del>￥{{boutiqueCourse.coursePrice.discountPrice}}</span>
                        <span style="float: right;font-size: 16px;color: #F00;" v-else>￥{{boutiqueCourse.coursePrice.discountPrice}}</span>
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <!--最近课程-->
            <div class="tab-pane fade" id="recent-course">
              <div class="row">
            ...
            <!--热门课程-->
            <div class="tab-pane fade in active" id="hot-course">
              <div class="row">
                <div class="col-md-3" v-for="hotCourse in hotCourseList">
                  <a class="recommend-courses-item" :href="'#/course/'+hotCourse.courseId">
                    <img :src="hotCourse.courseImage.smallImage" :alt="hotCourse.courseName">
                    <div class="recommend-courses-content">
                      <div class="recommend-courses-name">{{hotCourse.courseName}}</div>
                      <div class="recommend-courses-desc">{{hotCourse.description}}</div>
                      <div class="recommend-courses-users">
                        <i class="fa fa-users"></i>{{hotCourse.clickNumber}}
                        <span style="float: right;font-size: 16px;color: #F00;" v-if="hotCourse.coursePrice.isFree">免费</span>
                        <span style="float: right;font-size: 16px;color: #F00;" v-else-if="hotCourse.coursePrice.discountPrice!==hotCourse.coursePrice.originalPrice"><del style="font-size: 14px;color: #ccc;">￥{{hotCourse.coursePrice.originalPrice}}</del>￥{{hotCourse.coursePrice.discountPrice}}</span>
                        <span style="float: right;font-size: 16px;color: #F00;" v-else>￥{{hotCourse.coursePrice.discountPrice}}</span>
                      </div>
                    </div>
                  </a>
                </div>
          ...
          <div class="row learn-path-body">
            <div class="col-sm-3">
              <a class="learn-path-item" href="paths.htmlnewhand">
                <img src="http://39.96.200.195:8888/group1/M00/00/00/rBGPNVzN62KAVNCmAAAUwqf3L9w594.png">
...
export default {
  ...
  methods: {
    ...
    getBoutiqueCourseList () {
      api.findBoutiqueCourses(1, 8).then((response) => {
        this.BoutiqueCourseList = response.data.queryResult.list
      })
    },
    getHotCourseList () {
      api.findHotCourses(1, 8).then((response) => {
        this.hotCourseList = response.data.queryResult.list
      })
    },
  },
  created () {
